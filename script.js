document.addEventListener('DOMContentLoaded', function() {
    ...
    const questions = [
        {
            question: "¿Quién es Tom Sawyer?",
            answers: [
                "El protagonista, un niño travieso con mucha imaginación",
                "El amigo del protagonista",
                "El dueño del cementerio",
                "Uno de los cómplices del robo en el cementerio"
            ],
            correctAnswer: "El protagonista, un niño travieso con mucha imaginación"
        },
        {
            question: "¿Cuál es la idea principal de la lectura?",
            answers: [
                "La descripción de la infancia de Tom Sawyer",
                "Contar las aventuras imaginarias de Tom Sawyer y sus amigos",
                "La historia de un niño, que vive en un pequeño pueblo con su tía Polly",
                "Todas las respuestas son correctas"
            ],
            correctAnswer: "Todas las respuestas son correctas"
        },
        {
            question: "¿Quién es Mary?",
            answers: [
                "La medio hermana de Tom",
                "La tía de Tom",
                "La prima de Tom",
                "La mejor amiga de Tom"
            ],
            correctAnswer: "La prima de Tom"
        },
        {
            question: "¿En qué lugar se desarrolla la aventura de Tom, con el robo de la tumba?",
            answers: [
                "En el parque central",
                "En el cementerio",
                "En el parqueadero de la escuela",
                "En el patio de la casa de Tom"
            ],
            correctAnswer: "En el cementerio"
        },
        {
            question: "¿Cómo se llaman las tres figuras que espían en el cementerio?",
            answers: [
                "Indio Joe, Muff Potter y Dr. Robinson",
                "Thomas Sawyer, Joseph Harper y Huckleberry Finn",
                "Becky Thatcher, Polly y Jackson",
                "Sid, Amy Lawrence y Mary"
            ],
            correctAnswer: "Indio Joe, Muff Potter y Dr. Robinson"
        }
    ];
